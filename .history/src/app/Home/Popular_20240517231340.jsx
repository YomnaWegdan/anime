...
export default async function Popular() {
  ...
  return (
    ...
    <div className="  w-25  fixed-top">
    <h3 className='h6'>Top 5 Popular</h3>
    ...
    {sorted?.slice(0,5).map((anime) => 
        ...
        <div className='animate'>
            <Image width={150} height={150} src={anime.images.jpg.large_image_url} alt="" className=' w-25 rounded-3 ' />
        </div>
        </Link>
    )}
