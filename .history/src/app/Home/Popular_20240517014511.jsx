...
export default async function Popular() {
 ...
 export async function Animate(filtered){

    let response = await fetch(`https://api.jikan.moe/v4/top/anime?filter=${filtered}`);
    ...
    let popularAnimate = await Animate('bypopularity')
    console.log(popularAnimate)

  return (
    <div className="row justify-content-center align-items-center g-2">
    {popularAnimate.map(data=>
