...
export default async function page({params}) {
  ...
  return (
      ...
      <div className="slider-container row align-items-center justify-content-center g-5">
      ...
      {gallery.map((el, index )=>
        ...
        <Image width={200} height={300} src={el.jpg.image_url} alt="" className=' w-50 rounded-3 mx-auto' />
        </div>
