    ...
    <div className="row justify-content-between align-items-center bg-white shadow p-5">
        ...
        <div className="row justify-content-between align-items-center  p-5">
            ...
            <div className="characters">
                {characters.character.character?.map((character, index) => {
                    // const {role} = character
                    // const {images, name, mal_id} = character
                    return <Link to={`/character/${character.mal_id}`} key={index}>
                        <div className="character">
                            <Image width={280} height={400} src={character.images.jpg.large_image_url} alt="" className=' w-75 rounded-3 ' />
