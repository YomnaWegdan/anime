...
const handleSubmit = async (e) =>{
  ...
  return (
    ...
    <div className=' position-relative'>
      ...
      value={searchValue}/>
      <button type='submit' className='btn bg-link p-1 position-absolute top-0 end-0 ' onClick={handleSubmit}>
      <i className="fa-solid fa-magnifying-glass light-color fa-2xs"></i>
      </button>
    </div>
