...
const handleSubmit = async (e) =>{
  ...
  return (
    <div className='  mt-4'>
    <div>
      <input className=' form-control  w-75 mx-auto position-relative' placeholder='Search...'   onChange={handleChange}
      value={searchValue}/>
      <button type='submit' className='btn btn-info position-absolute top-0 ' onClick={handleSubmit}>
      search
      </button>
    </div>
